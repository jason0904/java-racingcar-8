...
public class RacingCarInputTest {
    ...
    public void carNameBlankTest() {
        ...
        assertThrows(IllegalArgumentException.class, () ->
            CarListValidation.validateCarNameBlank(List.of(string.split(","))));
    ...
    public void carNameLengthLimitTest() {
        String inputString = "pobi,abcdef";
    ...
    public void carNameDuplicateTest() {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () ->
            CarListValidation.validateCarNameDuplicate(List.of(inputString.split(","))));

        assertEquals(ErrorMessage.CARNAME_DUPLICATE_ERROR.getMessage() +  "\n겹치는 이름 : " + "pobi",
                exception.getMessage());
    }
